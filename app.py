...
/* v1.2.3 — iPad "Add to Home Screen" / standalone mode
   iPadOS can auto-collapse Streamlit's sidebar and remove its native reopen control.
   In standalone mode we force the sidebar to remain available as a permanent terminal rail. */
@media (display-mode: standalone) {
  ...
  /* No white Streamlit chrome in installed-app mode */
  [data-testid="stHeader"]{
    background:transparent !important;
    box-shadow:none !important;
  }

  /* The permanent rail makes Streamlit's collapse button unnecessary in standalone */
  [data-testid="stSidebarCollapseButton"]{
...
/* Extra fallback for iPad landscape when Safari standalone detection is inconsistent */
@media (hover:none) and (pointer:coarse) and (min-width:1000px) {
  body:has([data-testid="stSidebar"][aria-expanded="false"]) [data-testid="collapsedControl"]{
    display:flex !important;
    visibility:visible !important;
    opacity:1 !important;
