...
/* Hide Streamlit chrome but preserve the sidebar control */
...
/* v1.2.2 — iPad sidebar recovery */
[data-testid="stHeader"]{display:block!important;background:transparent!important;box-shadow:none!important;}
...
[data-testid="collapsedControl"] button,[data-testid="stSidebarCollapseButton"] button{
 background:#101925!important;color:#f4f7fb!important;border:1px solid #2b3c52!important;
 border-radius:10px!important;box-shadow:0 8px 24px rgba(0,0,0,.30)!important;
}



/* v1.2.5 — iPad / PWA: sidebar collapsible + always recoverable */
@media (display-mode: standalone) {
  [data-testid="stSidebar"]{
    visibility:visible !important;
  }

  /* Keep Streamlit's own collapse button available */
  [data-testid="stSidebarCollapseButton"]{
    display:flex !important;
    visibility:visible !important;
    opacity:1 !important;
  ...
  /* When collapsed, keep the reopen control visible */
  [data-testid="collapsedControl"]{
    display:flex !important;
    visibility:visible !important;
    opacity:1 !important;
...
/* iPad fallback outside standalone mode */
...
/* v1.2.6 — definitive iPad sidebar toggle
   Keep Streamlit header infrastructure alive because collapsedControl is mounted there. */
[data-testid="stHeader"]{
    display:block !important;
    visibility:visible !important;
    opacity:1 !important;
...
/* Never hide Streamlit's sidebar reopen control */
[data-testid="collapsedControl"]{
    display:flex !important;
    visibility:visible !important;
    opacity:1 !important;
...
/* Explicitly allow Streamlit to translate/collapse the sidebar. */
[data-testid="stSidebar"]{
    transition:transform .2s ease !important;
}

/* iPad / touch devices: make the reopen control large and unmistakable. */
