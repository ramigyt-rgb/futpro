...
/* Let Streamlit columns wrap instead of becoming unreadable on narrow screens */
...
@media (max-width:760px){
 ...
 [data-testid="stHorizontalBlock"]{display:flex!important;flex-direction:column!important;gap:.45rem!important}
...
def main():
    ...
    if menu_visible:
        ...
        menu_col, content_col = st.columns([0.235, 0.765], gap="large")
        with menu_col:
